...
<head>
    ...
    <title class="hidden">DATA SAHAM IDX</title>
    <style>
        ::-webkit-scrollbar {
            width: 10px;
        }
...
<body>
    <a href="config/logout.php" class="btn btn-danger position-absolute ms-2 hidden">Logout</a>
    <button class="btn btn-warning position-absolute ms-5 btn-print hidden" style="right: .5rem;">Cetak PDF</button>
    ...
    <form class="card-sm w-50 hidden" action="" method="GET">
        <div class="row no-gutters">
            <div class="col">
                <input type="text" class="form-control" placeholder="Search..." aria-label="Search..." name="key"
                    size="100" id="key-search">
            </div>
            <!--end col-->
            <div class="col-auto">
                <button class="btn btn-outline-secondary disabled" type="submit" name="Searching" id="btn-search">
        ...
        <table class="table">
            <thead>
                <tr class="text-uppercase">
                    ...
                    <th scope="col" class="text-center hidden">Edit</th>
                </tr>
            </thead>
